...
- [Frontend](./frontend/info.md)
  ...
  - [Core UI and Presentation Guide](./frontend/presentation/04_Core_UI_and_Presentation_Guide.md)
  - [Shadcn UI and Tailwind CSS](./frontend/presentation/05_ShadcnUI_and_TailwindCSS.md)
